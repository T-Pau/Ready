...
extern void joystick_set_value_absolute(unsigned int joyport, uint32_t value);
extern void joystick_set_value_or(unsigned int joyport, uint32_t value);
extern void joystick_set_value_and(unsigned int joyport, uint32_t value);
...
extern uint32_t get_joystick_value(int index);
...
extern uint32_t joystick_value[JOYSTICK_NUM + 1];
