...
struct DummyMachinePart: MachinePart {
    ...
    var priority: Int { return MachinePartLowPriority }

    init(identifier: String, name: String, fullName: String? = nil, variantName: String? = nil, iconName: String? = nil) {
    ...
    init(identifier: String, fullName: String, annotateName: Bool, basePart: MachinePart) {
        self.identifier = identifier
        name = basePart.name
        if annotateName {
            name = "\(name) (Automatic)"
